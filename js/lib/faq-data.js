...
<p>People using the same passphrase decode both of these to Hut 8 at Bletchley. People using a different passphrase decode them to somewhere else entirely. The passphrase doesn't encrypt the location; it selects which of an astronomical number of coordinate languages you're speaking, so the same nine characters name a different point on Earth for every passphrase.</p>
