...
<table>
  ...
  <tr><td><code>enc_pass</code></td><td>passphrase</td><td>Hard AES encryption (<code>?enc=</code> output)</td></tr>
			...
			
          {
            ...
            a: `<p>Yes. The <strong>🏠 Parcel</strong> source in Shape Import takes a street address or a raw <code>lat, lon</code> pair and fetches the legal cadastral parcel polygon at that location - <a href="https://geosonify.org/?adr=thp9rbe2rrcn~d7bc2zgkyb6w5rb1a7wc6iaa1wqr3m94cevj593h6q4q3k5h6qa3k6ry4l3jfn8zb3pzo2g33vxx3dy91raw3t9j8gxz79pl90ux9v44e8ff8c3del~d68yyu5wfo9s5kl2sqg0rbwijdsi5zubsemy9oszqk7ez1imrbzkqqbpzto7xa~d7l5nmm7ym0v21jv~d60tzlhcd65gfsdbvdb7k6tgegkzqp4tr9ez0txfp8b8~d7s34fdvft2303t6n825wwkn830vu4n830v6yn29odeghw30qokhqf68evhkluvhdheru7vyhe96oshh8ehnyfbwwhf5o~d6qw52kmqe5ik9kq43fwkea274k8ye0lk2gviseqrz5ae2rrcn">the actual surveyed property boundary</a>, not a guess. It becomes an ordinary Geosonify shape: simplify it, encode it in any vocabulary, share it as a link.</p>
<p>It works in two steps: the address is geocoded to a point (using the same OpenStreetMap geocoder as place search), or you can import directly from the pin location, then the official cadastral service for that country is asked <em>"which parcel contains this point?"</em>. If several parcels sit at that point - cross-leases, unit titles, an ambiguous address - a picker lets you choose. You can also share the whole thing as a single link with <code>?address=...</code>, including the full automatic pipeline (<code>&amp;auto=1&amp;grid=a&amp;result=s</code> and friends, exactly as for <code>?place=</code>).</p>
